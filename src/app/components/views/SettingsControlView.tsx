...
function toMcpServerIdCandidate(input: string) {
                        ...
                        <article key={server.id} className="rounded-xl border border-white/10 bg-black/20 p-3 space-y-3">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              {server.healthStatus && server.healthStatus !== "healthy" && (
                                <Chip variant={server.healthStatus === "failed" ? "stop" : "warn"}>{server.healthStatus}</Chip>
                              )}
                            </div>
                          </div>
